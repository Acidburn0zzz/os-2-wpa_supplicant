...
**
** Created: Sat Apr 14 17:17:45 2018
...
static const char qt_meta_stringdata_AddInterface[] = {
    "AddInterface\0\0sel\0interfaceSelected(QTreeWidgetItem*)\0"
};

const QMetaObject AddInterface::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AddInterface,
      qt_meta_data_AddInterface, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &AddInterface::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AddInterface))
...
int AddInterface::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: interfaceSelected((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
